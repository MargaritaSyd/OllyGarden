  ...
  return (
    ...
    >
      <div className="grid items-center gap-10 min-[1101px]:grid-cols-[minmax(0,563px)_minmax(0,1fr)] min-[1101px]:gap-16">
        <div className="cju-copy flex max-w-[563px] flex-col items-start gap-4">
        ...
        <img
          ...
          height={804}
          loading="lazy"
          className="cju-img h-auto w-full min-[1101px]:h-[388px] min-[1101px]:object-cover min-[1101px]:object-left"
        />
      </div>
    </InView>
  );
