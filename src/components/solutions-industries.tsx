...
const decoPixels = [
  { className: "top-6 right-0 size-11 bg-bitmap-shadow", parallax: "-0.12" },
  { className: "top-[68px] right-11 size-11 bg-sunflower", parallax: "0.16" },
  { className: "top-28 right-0 size-11 bg-bitmap-highlight", parallax: "-0.08" },
  { className: "top-[168px] right-24 size-[30px] bg-bitmap-mid", parallax: "0.1" },
  { className: "top-[348px] right-0 size-11 bg-bitmap-mid", parallax: "-0.15" },
  { className: "top-[396px] right-11 size-[30px] bg-sunflower", parallax: "0.12" },
  { className: "bottom-11 left-0 size-11 bg-sunflower", parallax: "0.14" },
  { className: "bottom-0 left-11 size-11 bg-bitmap-shadow", parallax: "-0.1" },
  { className: "bottom-[132px] left-11 size-11 bg-bitmap-mid", parallax: "0.09" },
  { className: "bottom-[180px] left-0 size-[30px] bg-bitmap-highlight", parallax: "-0.16" },
  { className: "bottom-[268px] left-[88px] size-[30px] bg-sunflower", parallax: "0.12" },
  { className: "bottom-[312px] left-0 size-11 bg-bitmap-mid", parallax: "-0.08" },
] as const;
...
export function SolutionsIndustries() {
  return (
    ...
    >
      <div className="inds-deco pointer-events-none absolute inset-0" aria-hidden="true">
        {decoPixels.map((pixel) => (
          <div
            key={pixel.className}
            data-parallax={pixel.parallax}
            className={`sol-ipx absolute opacity-30 max-[880px]:size-7 ${pixel.className}`}
          />
        ))}
      </div>
      ...
      <div className="relative z-[1] mx-auto flex max-w-[1232px] flex-col gap-16 max-[1100px]:gap-12 max-[880px]:gap-8">
        {solutionIndustries.map((industry) => (
          <InView
            ...
            threshold={0.22}
            rootMargin="0px"
            className={industry.flip ? "ind-rv ind-rv--right" : "ind-rv ind-rv--left"}
          >
            <article>
              <Link
                href={industry.href}
              ...
              >
                ...
                >
                  <div data-ind-par className="ind-par absolute inset-x-0 -inset-y-5">
