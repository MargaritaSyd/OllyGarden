...
import { webinarsHero } from "@/lib/webinars";

export function WebinarsHero() {
  return (
    <section
      className="relative overflow-hidden px-[clamp(1.5rem,7.25vw,6.5rem)] pt-[clamp(7.5rem,13vw,11rem)] pb-[clamp(2.5rem,5vw,4rem)] min-[768px]:min-h-[502px] max-[880px]:px-6 max-[880px]:pt-[132px] max-[880px]:pb-12"
