    ...
    <section aria-labelledby="client-title">
      <div className="mx-auto w-full max-w-[1328px] px-5 py-[clamp(4.75rem,8vw,7.25rem)] sm:px-12">
        ...
        <figure className="grid bg-[#011407] md:grid-cols-[minmax(15rem,24.875rem)_minmax(0,1fr)]">
          <div className="relative flex max-w-[400px] flex-col md:max-w-none">
            ...
            <img
              ...
              width={398}
              height={352}
              className="aspect-[199/176] w-full object-cover"
            />
            <div className="absolute inset-x-0 bottom-0">
              <p className="w-[66%] min-w-[12.5rem] bg-olive px-[22px] py-3.5 text-[15px] font-semibold text-white">
                {current.name}
              </p>
              <p className="w-[calc(100%+6.25rem)] max-w-none bg-sunflower px-[22px] py-3.5 text-[14.5px] font-semibold text-[#394813]">
                {current.role}
              </p>
            </div>
          </div>
          <blockquote className="px-[clamp(1.75rem,4.5vw,4rem)] py-[clamp(1.75rem,3.4vw,2.875rem)]">
            <QuoteMark />
